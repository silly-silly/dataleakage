...
plt.barh(list(range(importances[indices].shape[0])),importances[indices],
       color="gray", align="center")
#plt.bar(range(importances[indices].shape[0]), importances[indices],
#       color="r", yerr=std[indices], align="center")
plt.yticks(list(range(importances[indices].shape[0])), data.columns.values, rotation='horizontal')
